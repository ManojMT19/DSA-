...
public class ssss
{
    public static String removeKdigits_brute(String num, int k)
    {
        ...
        while (i < sb.length() - 1 && count < k)
        {
            if (sb.charAt(i) > sb.charAt(i + 1))
            {
                ...
                // After deleting a digit, move one step back because a new "bad pair" might have been created.

                // 1 2 3 1 3 2
                // After deleting 3, the number becomes 12132. The new adjacent pair 2 > 1 is formed. If we don't move i back, we skip comparing 2 and 1, missing a necessary deletion and producing a larger number.
    ...
    public static void main(String[] args)
    {
        ...
        String res = removeKdigits_brute(num, 2);
